...
resource "aws_instance" "chips-e2e-pilot" {
  ...
  #   for_each = [
  #     for block_device in data.aws_ami.chips-e2e-pilot-base-ami.block_device_mappings :
  #     block_device if block_device.device_name != data.aws_ami.chips-e2e-pilot-base-ami.root_device_name
  #   ]
